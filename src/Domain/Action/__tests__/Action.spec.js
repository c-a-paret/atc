...
describe("Waypoint", () => {
    ...
    test("Turns to face waypoint top left quadrant", () => {
        const aeroplane = new Aeroplane("BA123", 600, 600, 200, 90, 5000, 3)
    ...
    test("Is actionable if far away from waypoint", () => {
        const aeroplane = new Aeroplane("BA123", 100, 672, 200, 90, 5000, 3)
        let waypoint = "LAM";
    ...
    test("Is not actionable if close to waypoint", () => {
        const aeroplane = new Aeroplane("BA123", 495, 505, 200, 90, 5000, 3)
        let waypoint = "LAM";
...
describe("Landing", () => {
    ...
    test("Applies landing sequence actions", () => {
        ...
        const aeroplane = new Aeroplane("BA123", x, y, speed, heading, altitude, 3)
